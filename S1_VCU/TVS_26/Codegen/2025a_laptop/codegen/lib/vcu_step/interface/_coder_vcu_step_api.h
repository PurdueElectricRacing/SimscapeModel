...
#ifndef typedef_b_pVCU_struct
#define typedef_b_pVCU_struct
typedef struct {
  real32_T TH_RAW;
  real32_T ST_RAW;
  real32_T VB_RAW;
...
#ifndef typedef_c_pVCU_struct
#define typedef_c_pVCU_struct
typedef struct {
  real32_T TH;
  real32_T TH_PO;
  real32_T TH_RG;
...
void vcu_step(pVCU_struct *p, b_pVCU_struct *x, c_pVCU_struct *y);
