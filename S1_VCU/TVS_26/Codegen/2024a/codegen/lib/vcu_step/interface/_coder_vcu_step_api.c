                               ...
                               pVCU_struct *y)
{
  ...
  static const char_T *fieldNames[40] = {"r",
                                         "ht",
                                         "wb",
                                         "gr",
                                         "MAX_ABS_WM",
...
static const mxArray *emlrt_marshallOut(const yVCU_struct *u)
{
  ...
  static const char_T *sv[28] = {"VCU_MODE",
                                 "TH",
                                 "TH_PO",
                                 "TH_RG",
                                 "ST",
  ...
  real32_T *pData;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 28, (const char_T **)&sv[0]));
  b_y = NULL;
  ...
  *(real32_T *)emlrtMxGetData(m12) = u->MC;
  emlrtAssign(&n_y, m12);
  emlrtSetFieldR2017b(y, 0, "MC", n_y, 13);
  o_y = NULL;
  m13 = emlrtCreateNumericMatrix(1, 1, mxSINGLE_CLASS, mxREAL);
  *(real32_T *)emlrtMxGetData(m13) = u->IC;
  emlrtAssign(&o_y, m13);
  emlrtSetFieldR2017b(y, 0, "IC", o_y, 14);
  p_y = NULL;
  m14 = emlrtCreateNumericMatrix(1, 1, mxSINGLE_CLASS, mxREAL);
  *(real32_T *)emlrtMxGetData(m14) = u->BT;
  emlrtAssign(&p_y, m14);
  emlrtSetFieldR2017b(y, 0, "BT", p_y, 15);
  emlrtSetFieldR2017b(y, 0, "TO", b_emlrt_marshallOut(u->TO), 16);
  q_y = NULL;
  m15 =
      emlrtCreateNumericArray(2, (const void *)&iv1[0], mxSINGLE_CLASS, mxREAL);
  b_pData = (real32_T *)emlrtMxGetData(m15);
  for (i = 0; i < 10; i++) {
    b_pData[i] = u->IB_AVG_buffer[i];
  }
  emlrtAssign(&q_y, m15);
  emlrtSetFieldR2017b(y, 0, "IB_AVG_buffer", q_y, 17);
  r_y = NULL;
  m16 = emlrtCreateNumericMatrix(1, 1, mxSINGLE_CLASS, mxREAL);
  *(real32_T *)emlrtMxGetData(m16) = u->PB;
  emlrtAssign(&r_y, m16);
  emlrtSetFieldR2017b(y, 0, "PB", r_y, 18);
  emlrtSetFieldR2017b(y, 0, "WW", b_emlrt_marshallOut(u->WW), 19);
  s_y = NULL;
  m17 = emlrtCreateNumericMatrix(1, 1, mxSINGLE_CLASS, mxREAL);
  *(real32_T *)emlrtMxGetData(m17) = u->IB_AVG;
  emlrtAssign(&s_y, m17);
  emlrtSetFieldR2017b(y, 0, "IB_AVG", s_y, 20);
  emlrtSetFieldR2017b(y, 0, "TO_BL_PO", b_emlrt_marshallOut(u->TO_BL_PO), 21);
  emlrtSetFieldR2017b(y, 0, "TO_BL_RG", b_emlrt_marshallOut(u->TO_BL_RG), 22);
  emlrtSetFieldR2017b(y, 0, "AC_MW", b_emlrt_marshallOut(u->AC_MW), 23);
  emlrtSetFieldR2017b(y, 0, "SK_TO", b_emlrt_marshallOut(u->SK_TO), 24);
  emlrtSetFieldR2017b(y, 0, "TORQUE_LIM_NEG",
                      b_emlrt_marshallOut(u->TORQUE_LIM_NEG), 25);
  emlrtSetFieldR2017b(y, 0, "TORQUE_LIM_POS",
                      b_emlrt_marshallOut(u->TORQUE_LIM_POS), 26);
  emlrtSetFieldR2017b(y, 0, "SPEED_OUT", b_emlrt_marshallOut(u->SPEED_OUT), 27);
  return y;
}
                               ...
                               xVCU_struct *y)
{
  ...
  static const char_T *fieldNames[15] = {
      "VCU_MODE_REQ", "TH_RAW", "ST_RAW", "VB_RAW", "WM_RAW",
      "GS_RAW",       "AV_RAW", "IB_RAW", "MT_RAW", "IGBT_T_RAW",
      "INV_T_RAW",    "MC_RAW", "IC_RAW", "BT_RAW", "TO_RAW"};
  emlrtMsgIdentifier thisId;
  thisId.fParent = parentId;
  thisId.bParentIsCell = false;
...
{
  static const int32_T dims = 0;
  static const char_T *fieldNames[28] = {"VCU_MODE",
                                         "TH",
                                         "TH_PO",
                                         "TH_RG",
                                         "ST",
  ...
  y->MC = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 13, "MC")),
      &thisId);
  thisId.fIdentifier = "IC";
  y->IC = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 14, "IC")),
      &thisId);
  ...
  h_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 22, "TO_BL_RG")),
      &thisId, y->TO_BL_RG);
  thisId.fIdentifier = "AC_MW";
  h_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 23, "AC_MW")),
      &thisId, y->AC_MW);
  thisId.fIdentifier = "SK_TO";
  h_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 24, "SK_TO")),
      &thisId, y->SK_TO);
  ...
  h_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 27, "SPEED_OUT")),
      &thisId, y->SPEED_OUT);
  emlrtDestroyArray(&u);
}
