classdef yVCU_Master < handle
    ...
    % VCU mode variables
        ...
        VCU_mode; % vcu mode; 1 = equal throttle (ET), 2 = proportional toruq (PT), 3 = variable speed (VS), 4 = variable torque (VT), 5 = regen (PT_R)
    ...
    % Regen mode (RG) variables
        TO_RG; % Torque setpoint for motors in RG mode Unit: [Nm] Size: [1 2]
