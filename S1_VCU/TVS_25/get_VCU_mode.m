function y = get_VCU_mode(p,f,x,y)
    ...
    VS_flags = [f.CS_SFLAG, f.TB_SFLAG, f.WT_SFLAG, f.IV_SFLAG, f.BT_SFLAG, f.MT_SFLAG, f.CO_SFLAG, f.MO_SFLAG, f.GS_FFLAG, f.VS_PFLAG];
    VS_flagCheck = [p.CS_SFLAG_True, p.TB_SFLAG_True, p.WT_SFLAG_True, p.IV_SFLAG_True, p.BT_SFLAG_True, p.MT_SFLAG_True, p.CO_SFLAG_True, p.MO_SFLAG_True, p.GS_FFLAG_True, p.VS_PFLAG_True];
    ...
    VT_flags = [f.CS_SFLAG, f.TB_SFLAG, f.SS_SFLAG, f.WT_SFLAG, f.IV_SFLAG, f.BT_SFLAG, f.MT_SFLAG, f.CO_SFLAG, f.MO_SFLAG, ...
             f.SS_FFLAG, f.AV_FFLAG, f.GS_FFLAG, f.VT_PFLAG];
    VT_flagCheck = [p.CS_SFLAG_True, p.TB_SFLAG_True, p.SS_SFLAG_True, p.WT_SFLAG_True, p.IV_SFLAG_True, p.BT_SFLAG_True, p.MT_SFLAG_True, p.CO_SFLAG_True, p.MO_SFLAG_True, ...
                 p.SS_FFLAG_True, p.AV_FFLAG_True, p.GS_FFLAG_True, p.VT_PFLAG_True];
