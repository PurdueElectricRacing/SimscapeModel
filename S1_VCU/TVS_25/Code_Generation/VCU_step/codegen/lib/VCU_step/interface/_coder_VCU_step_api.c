                               ...
                               pVCU_struct *y)
{
  ...
  static const char_T *fieldNames[113] = {"r",
                                          "ht",
                                          "gr",
                                          "Ns",
                                          "PT_permit_N",
  ...
  emlrtCheckStructR2012b((emlrtConstCTX)sp, parentId, u, 113,
  ...
  y->PT_WM_lb = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 78, "PT_WM_lb")),
      &thisId);
  thisId.fIdentifier = "PT_WM_ub";
  y->PT_WM_ub = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 79, "PT_WM_ub")),
      &thisId);
  thisId.fIdentifier = "PT_VB_lb";
  y->PT_VB_lb = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 80, "PT_VB_lb")),
      &thisId);
  thisId.fIdentifier = "PT_VB_ub";
  y->PT_VB_ub = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 81, "PT_VB_ub")),
      &thisId);
  ...
  y->dST_DB = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 98, "dST_DB")),
      &thisId);
  thisId.fIdentifier = "MAX_r";
  y->MAX_r = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 99, "MAX_r")),
      &thisId);
  ...
  y->TV_ST_lb = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 103, "TV_ST_lb")),
      &thisId);
  thisId.fIdentifier = "TV_ST_ub";
  y->TV_ST_ub = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 104, "TV_ST_ub")),
      &thisId);
  thisId.fIdentifier = "TV_GS_lb";
  y->TV_GS_lb = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 105, "TV_GS_lb")),
      &thisId);
  thisId.fIdentifier = "TV_GS_ub";
  y->TV_GS_ub = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 106, "TV_GS_ub")),
      &thisId);
  thisId.fIdentifier = "TV_PI";
  y->TV_PI = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 107, "TV_PI")),
      &thisId);
  thisId.fIdentifier = "TC_eps";
  y->TC_eps = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 108, "TC_eps")),
      &thisId);
  thisId.fIdentifier = "TC_SR_threshold";
  y->TC_SR_threshold =
      c_emlrt_marshallIn(sp,
                         emlrtAlias(emlrtGetFieldR2017b(
                             (emlrtConstCTX)sp, u, 0, 109, "TC_SR_threshold")),
                         &thisId);
  thisId.fIdentifier = "TC_highs_to_engage";
  y->TC_highs_to_engage = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 110,
                                     "TC_highs_to_engage")),
      &thisId);
  ...
  y->WM_VS_LS = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 112, "WM_VS_LS")),
      &thisId);
  emlrtDestroyArray(&u);
}
...
static const mxArray *emlrt_marshallOut(const yVCU_struct *u)
{
  ...
  static const char_T *sv[42] = {"PT_permit_buffer",
                                 "VS_permit_buffer",
                                 "VT_permit_buffer",
                                 "VCU_mode",
                                 "IB_CF_buffer",
  ...
  real32_T *pData;
  y = NULL;
  emlrtAssign(&y, emlrtCreateStructMatrix(1, 1, 42, (const char_T **)&sv[0]));
...
{
  static const int32_T dims = 0;
  static const char_T *fieldNames[42] = {"PT_permit_buffer",
                                         "VS_permit_buffer",
                                         "VT_permit_buffer",
                                         "VCU_mode",
                                         "IB_CF_buffer",
  ...
  thisId.fParent = parentId;
  thisId.bParentIsCell = false;
  emlrtCheckStructR2012b((emlrtConstCTX)sp, parentId, u, 42,
                         (const char_T **)&fieldNames[0], 0U,
                         (const void *)&dims);
  ...
  y->GS_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 10, "GS_CF")),
      &thisId);
  thisId.fIdentifier = "AV_CF";
  e_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 11, "AV_CF")),
      &thisId, y->AV_CF);
  thisId.fIdentifier = "IB_CF";
  y->IB_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 12, "IB_CF")),
      &thisId);
  thisId.fIdentifier = "MT_CF";
  y->MT_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 13, "MT_CF")),
      &thisId);
  thisId.fIdentifier = "CT_CF";
  y->CT_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 14, "CT_CF")),
      &thisId);
  thisId.fIdentifier = "IT_CF";
  y->IT_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 15, "IT_CF")),
      &thisId);
  thisId.fIdentifier = "MC_CF";
  y->MC_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 16, "MC_CF")),
      &thisId);
  thisId.fIdentifier = "IC_CF";
  y->IC_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 17, "IC_CF")),
      &thisId);
  thisId.fIdentifier = "BT_CF";
  y->BT_CF = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 18, "BT_CF")),
      &thisId);
  thisId.fIdentifier = "AG_CF";
  e_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 19, "AG_CF")),
      &thisId, y->AG_CF);
  thisId.fIdentifier = "TO_CF";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 20, "TO_CF")),
      &thisId, y->TO_CF);
  thisId.fIdentifier = "VT_DB_CF";
  y->VT_DB_CF = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 21, "VT_DB_CF")),
      &thisId);
  thisId.fIdentifier = "TV_PP_CF";
  y->TV_PP_CF = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 22, "TV_PP_CF")),
      &thisId);
  thisId.fIdentifier = "TC_TR_CF";
  y->TC_TR_CF = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 23, "TC_TR_CF")),
      &thisId);
  ...
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 28, "WM_CS")),
      &thisId, y->WM_CS);
  thisId.fIdentifier = "TO_ET";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 29, "TO_ET")),
      &thisId, y->TO_ET);
  thisId.fIdentifier = "TO_AB_MX";
  y->TO_AB_MX = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 30, "TO_AB_MX")),
      &thisId);
  thisId.fIdentifier = "TO_DR_MX";
  y->TO_DR_MX = c_emlrt_marshallIn(
      sp,
      emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 31, "TO_DR_MX")),
      &thisId);
  thisId.fIdentifier = "TO_PT";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 32, "TO_PT")),
      &thisId, y->TO_PT);
  ...
  y->SR = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 39, "SR")),
      &thisId);
  thisId.fIdentifier = "WM_VS";
  d_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 40, "WM_VS")),
      &thisId, y->WM_VS);
  thisId.fIdentifier = "SR_VS";
  y->SR_VS = c_emlrt_marshallIn(
      sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 41, "SR_VS")),
      &thisId);
  emlrtDestroyArray(&u);
}
