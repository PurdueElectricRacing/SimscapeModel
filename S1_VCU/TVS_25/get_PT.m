 function y = get_PT(p,y)
    ...
    motor_max_T = interp2(p.PT_WM_brkpt, p.PT_VB_brkpt, p.PT_maxT_table, max(y.WT_CF.*p.gr), y.VB_CF);
    ...
    y.TO_DR_MX = min([mT_derated, cT_derated, iT_derated, Cm_derated, Ci_derated, bT_derated, bI_derated, Vb_derated]); % max T after derating
