###########################################################################
## Makefile generated for component 'get_ET'. 
## 
## Makefile     : get_ET_rtw.mk
## Generated on : Sat Feb 08 09:06:46 2025
## Final product: ./get_ET.lib
...
START_DIR                 = C:/Users/Inver/DOCUME~1/GitHub/SIMSCA~1/S1_VCU/TVS_25/Code Generation/get_ET
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = get_ET_rtw_comp.rsp
CMD_FILE                  = get_ET_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = get_ET.lib
...
DEFINES_STANDARD = -DMODEL=get_ET
...
SRCS = $(START_DIR)/codegen/lib/get_ET/get_ET.c
...
%.o : $(START_DIR)/codegen/lib/get_ET/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_ET/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_ET/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_ET/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_ET/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
get_ET.o : $(START_DIR)/codegen/lib/get_ET/get_ET.c
	$(CC) $(CFLAGS) -o "$@" "$<"
