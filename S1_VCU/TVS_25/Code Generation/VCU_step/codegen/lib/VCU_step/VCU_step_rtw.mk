...
## Generated on : Sat Feb 01 21:19:19 2025
...
START_DIR                 = C:/Users/Inver/DOCUME~1/GitHub/SIMSCA~1/S1_VCU/TVS_25/Code Generation/VCU_step
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
SRCS = $(START_DIR)/codegen/lib/VCU_step/VCU_step.c
...
%.o : $(START_DIR)/codegen/lib/VCU_step/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/VCU_step/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/VCU_step/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/VCU_step/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/VCU_step/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
VCU_step.o : $(START_DIR)/codegen/lib/VCU_step/VCU_step.c
	$(CC) $(CFLAGS) -o "$@" "$<"
