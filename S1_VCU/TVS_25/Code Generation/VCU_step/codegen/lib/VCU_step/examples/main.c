...
Change this value to the value that the application requires. */
  ...
  result->WT_SFLAG = result_tmp;
  result->IV_SFLAG = result_tmp;
  result->BT_SFLAG = result_tmp;
  result->MT_SFLAG = result_tmp;
  result->CT_SFLAG = result_tmp;
  result->MO_SFLAG = result_tmp;
  result->SS_FFLAG = result_tmp;
  result->AV_FFLAG = result_tmp;
  result->GS_FFLAG = result_tmp;
  result->VS_PFLAG = result_tmp;
  result->VT_PFLAG = result_tmp;
...
Change this value to the value that the application requires. */
  ...
  result->WM_VS[0] = result->WT_CF[0];
  result->TO_VT[0] = result->WT_CF[0];
  result->TO_CF[1] = result->WT_CF[1];
  result->TO_ET[1] = result->WT_CF[1];
  result->TO_PT[1] = result->WT_CF[1];
  result->WM_VS[1] = result->WT_CF[1];
