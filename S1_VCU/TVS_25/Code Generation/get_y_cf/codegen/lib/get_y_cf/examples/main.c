...
#include "main.h"
#include "get_y_cf.h"
#include "get_y_cf_terminate.h"
#include "get_y_cf_types.h"
#include "rt_nonfinite.h"

/* Function Declarations */
static void argInit_150x50_real_T(double result[7500]);

static void argInit_1x10_real_T(double result[10]);

static void argInit_1x150_real_T(double result[150]);
...
static void argInit_griddedInterpolant(griddedInterpolant *result);
...
Change this value to the value that the application requires. */
  argInit_1x150_real_T(result->f1);
  argInit_1x50_real_T(result->f2);
}

/*
 * Arguments    : griddedInterpolant *result
 * Return Type  : void
 */
static void argInit_griddedInterpolant(griddedInterpolant *result)
{
...
Change this value to the value that the application requires. */
  ...
  argInit_cell_0(&result->gridVectors_);
  argInit_150x50_real_T(result->gridValues);
  result->validState = argInit_boolean_T();
  result->interpToUseForCubic = result_tmp;
  result->extrapToUseForCubic = result_tmp;
}
...
Change this value to the value that the application requires. */
  ...
  argInit_griddedInterpolant(&result->torque_interpolant);
