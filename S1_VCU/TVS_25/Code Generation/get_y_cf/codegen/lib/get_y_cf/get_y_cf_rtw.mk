###########################################################################
## Makefile generated for component 'get_y_cf'. 
## 
## Makefile     : get_y_cf_rtw.mk
## Generated on : Sat Feb 01 15:01:33 2025
## Final product: ./get_y_cf.lib
...
PRODUCT_NAME              = get_y_cf
MAKEFILE                  = get_y_cf_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2023b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2023b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Inver/DOCUME~1/GitHub/SIMSCA~1/S1_VCU/TVS_25/Code Generation/get_y_cf
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = ../../..
COMPILER_COMMAND_FILE     = get_y_cf_rtw_comp.rsp
CMD_FILE                  = get_y_cf_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = get_y_cf.lib
...
DEFINES_STANDARD = -DMODEL=get_y_cf
...
SRCS = $(START_DIR)/codegen/lib/get_y_cf/get_y_cf.c
...
%.o : $(START_DIR)/codegen/lib/get_y_cf/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_y_cf/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_y_cf/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/get_y_cf/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/codegen/lib/get_y_cf/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
get_y_cf.o : $(START_DIR)/codegen/lib/get_y_cf/get_y_cf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
