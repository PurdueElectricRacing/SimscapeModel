function D2zero_create_tvs_vars
...
[v_sweep,w_sweep,minK_table,voltages,max_rpm] = D2zero_create_minK_table();
V = v_sweep;
w = w_sweep;
minK = minK_table;

[~,~,maxK_table,voltages,RPM_Field_Weakening,v_grid,w_grid] = D2zero_create_maxK_table(v_sweep,w_sweep);
maxK = maxK_table;
...
[yaw_table, max_s_bp, max_v_bp] = D2zero_create_yaw_table();
s = max_s_bp;
v = max_v_bp;
...
save("D2zero_data/D2zero_tvs_vars.mat")
