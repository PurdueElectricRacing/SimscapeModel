function D2zero_create_tvs_struct
...
% initial conditions
tvs.ic.R = D2zero_c_compute_R(tvs.const.XYZs);
...
[v_sweep,w_sweep,minK_table] = D2zero_create_minK_table();
tvs.bp.V = v_sweep;
tvs.bp.w = w_sweep;
tvs.tbl.k_min = minK_table;

[~,~,maxK_table] = D2zero_create_maxK_table(v_sweep,w_sweep);
...
% Save Parameters
save("D2zero_data/D2zero_tvs_parameters.mat","tvs")
