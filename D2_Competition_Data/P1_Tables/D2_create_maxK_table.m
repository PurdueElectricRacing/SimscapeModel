function [v_sweep,w_sweep,maxK_table,voltages,RPM_Field_Weakening,v_grid,w_grid] = D2_create_maxK_table(v_sweep,w_sweep)
%% Parameters
...
for i = 1:1:num_datasets
    ...
    motor_data(:, :, i) = table2array(readtable("D2_Data/D2_all_motor_data.xlsx", opts, "UseExcel", false));
