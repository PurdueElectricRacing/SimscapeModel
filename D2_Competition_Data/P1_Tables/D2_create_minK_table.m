...
function [v_sweep,w_sweep,minK_table,voltages,max_rpm] = D2_create_minK_table()
%% Parameters
...
for i = 1:1:num_datasets
    ...
    motor_constants(:,i) = table2array(readtable("D2_Data/D2_all_motor_data.xlsx", opts, "UseExcel", false));
end
