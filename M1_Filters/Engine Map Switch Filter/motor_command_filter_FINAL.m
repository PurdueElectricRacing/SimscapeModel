...
%% The function
function [smoothed_command, TVS_PERMIT, FINISHED_SMOOTHING] = motor_command_filter_FINAL(TVS_command_in, Equal_command_in, TVS_STATE, LAST_TVS_STATE, command_last_sent, FINISHED_SMOOTHING,alpha,dk_thresh)
