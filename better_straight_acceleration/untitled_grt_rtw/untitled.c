...
static real_T untitled_norm(const real_T x[2]);
static void untitled_pchip(const real_T x[7], const real_T y[7], const real_T
  xx[4], real_T v[4]);
...
void untitled_step(void)
{
  ...
  x_tmp = fabs(untitled_P.Constant_Value);
  if (x_tmp > 5.0) {
    if (untitled_P.Constant_Value < 0.0) {
      left_steering_angle = -1.0;
    } else if (untitled_P.Constant_Value > 0.0) {
      left_steering_angle = 1.0;
    } else if (untitled_P.Constant_Value == 0.0) {
   ...
   *  Constant: '<Root>/Constant'
   */
  rack_displacement = untitled_P.steer_slope * untitled_P.inch2mm *
    untitled_P.Constant_Value;
  left_steering_angle = -(((-rack_displacement * -rack_displacement *
    untitled_P.S2 + untitled_P.S1 * rt_powd_snf(-rack_displacement, 3.0)) +
    untitled_P.S3 * -rack_displacement) + untitled_P.S4) * untitled_P.deg2rad;
  rack_displacement = (((rack_displacement * rack_displacement * untitled_P.S2 +
    untitled_P.S1 * rt_powd_snf(rack_displacement, 3.0)) + untitled_P.S3 *
                        rack_displacement) + untitled_P.S4) * untitled_P.deg2rad;
  ...
  if (x_tmp > 0.1) {
    left_steering_angle = untitled_P.s[0] * untitled_P.Constant_Value;
    rack_displacement = untitled_P.l[0] * untitled_P.Constant_Value +
      untitled_P.Constant_Value;
    phi_fl = rt_atan2d_snf(rack_displacement, left_steering_angle +
      untitled_P.Constant_Value);
    left_steering_angle = rt_atan2d_snf(rack_displacement,
      untitled_P.Constant_Value - left_steering_angle);
    n_idx_1 = untitled_P.s[1] * untitled_P.Constant_Value;
    rack_displacement = untitled_P.Constant_Value - untitled_P.l[1] *
      untitled_P.Constant_Value;
    phi_rl = rt_atan2d_snf(rack_displacement, n_idx_1 +
      untitled_P.Constant_Value);
    rack_displacement = rt_atan2d_snf(rack_displacement,
      untitled_P.Constant_Value - n_idx_1);
  } else {
    phi_fl = 0.0;
    left_steering_angle = 0.0;
    phi_rl = 0.0;
  ...
  rtb_TmpSignalConversionAtSFun_0[0] = untitled_P.Constant_Value * untitled_P.s
    [0] + untitled_P.Constant_Value;
  acker_steer_angles_idx_0 = untitled_P.Constant_Value * untitled_P.l[0] +
    untitled_P.Constant_Value;
  rtb_TmpSignalConversionAtSFun_0[1] = acker_steer_angles_idx_0;
  left_steering_angle = untitled_norm(rtb_TmpSignalConversionAtSFun_0);
  mu_x_tmp = cos(phi_fl);
  if (fabs(left_steering_angle * mu_x_tmp) > 0.0) {
    acker_steer_angles_idx_1 = untitled_P.RE * untitled_P.Constant_Value;
    left_steering_angle = acker_steer_angles_idx_1 / (left_steering_angle *
      mu_x_tmp) - 1.0;
    rtb_TmpSignalConversionAtSFun_0[0] = untitled_P.Constant_Value *
      -untitled_P.s[0] + untitled_P.Constant_Value;
    rtb_TmpSignalConversionAtSFun_0[1] = acker_steer_angles_idx_0;
    phi_fl = acker_steer_angles_idx_1 / (untitled_norm
      (rtb_TmpSignalConversionAtSFun_0) * cos(SA_fr)) - 1.0;
    rtb_TmpSignalConversionAtSFun_0[0] = untitled_P.Constant_Value *
      untitled_P.s[1] + untitled_P.Constant_Value;
    acker_steer_angles_idx_0 = untitled_P.Constant_Value * -untitled_P.l[1] +
      untitled_P.Constant_Value;
    rtb_TmpSignalConversionAtSFun_0[1] = acker_steer_angles_idx_0;
    phi_rl = acker_steer_angles_idx_1 / (untitled_norm
      (rtb_TmpSignalConversionAtSFun_0) * cos(-phi_rl)) - 1.0;
    rtb_TmpSignalConversionAtSFun_0[0] = untitled_P.Constant_Value *
      -untitled_P.s[1] + untitled_P.Constant_Value;
    rtb_TmpSignalConversionAtSFun_0[1] = acker_steer_angles_idx_0;
    rack_displacement = acker_steer_angles_idx_1 / (untitled_norm
      (rtb_TmpSignalConversionAtSFun_0) * cos(-rack_displacement)) - 1.0;
  } else {
    left_steering_angle = 0.0;
    phi_fl = 0.0;
    phi_rl = 0.0;
  ...
  acker_steer_angles_idx_1 = untitled_P.A1 * untitled_P.Constant1_Value[0] +
    untitled_P.A2;
  max_current[0] = fabs(untitled_P.Constant1_Value[0]);
  acker_steer_angles_idx_0 = untitled_P.Constant1_Value[0] *
    untitled_P.Constant1_Value[0];
  mu_x = (acker_steer_angles_idx_0 * untitled_P.B1 + untitled_P.B2 *
          untitled_P.Constant1_Value[0]) + untitled_P.B3;
  kx_idx_1 = untitled_P.A1 * untitled_P.Constant1_Value[1] + untitled_P.A2;
  max_current[1] = fabs(untitled_P.Constant1_Value[1]);
  n_idx_2 = untitled_P.Constant1_Value[1] * untitled_P.Constant1_Value[1];
  mu_x_0 = (n_idx_2 * untitled_P.B1 + untitled_P.B2 *
            untitled_P.Constant1_Value[1]) + untitled_P.B3;
  kx_idx_2 = untitled_P.A1 * untitled_P.Constant1_Value[2] + untitled_P.A2;
  max_current[2] = fabs(untitled_P.Constant1_Value[2]);
  rtb_Fx_max_idx_2 = untitled_P.Constant1_Value[2] * untitled_P.Constant1_Value
    [2];
  mu_x_1 = (rtb_Fx_max_idx_2 * untitled_P.B1 + untitled_P.B2 *
            untitled_P.Constant1_Value[2]) + untitled_P.B3;
  kx_idx_3 = untitled_P.A1 * untitled_P.Constant1_Value[3] + untitled_P.A2;
  max_current[3] = fabs(untitled_P.Constant1_Value[3]);
  mu_x_tmp = untitled_P.Constant1_Value[3] * untitled_P.Constant1_Value[3];
  mu_x_2 = (mu_x_tmp * untitled_P.B1 + untitled_P.B2 *
            untitled_P.Constant1_Value[3]) + untitled_P.B3;
  untitled_pchip(untitled_P.FZ_C, untitled_P.C_param, max_current, C);
  mu_y = ((acker_steer_angles_idx_0 * untitled_P.C2 + untitled_P.C1 *
           rt_powd_snf(untitled_P.Constant1_Value[0], 3.0)) + untitled_P.C3 *
          untitled_P.Constant1_Value[0]) + untitled_P.C4;
  acker_steer_angles_idx_0 = mu_x * untitled_P.Constant1_Value[0];
  n_idx_1 = acker_steer_angles_idx_1 * left_steering_angle /
    acker_steer_angles_idx_0;
  rtb_Fx_max_idx_0 = acker_steer_angles_idx_0;
  mu_y_0 = ((n_idx_2 * untitled_P.C2 + untitled_P.C1 * rt_powd_snf
             (untitled_P.Constant1_Value[1], 3.0)) + untitled_P.C3 *
            untitled_P.Constant1_Value[1]) + untitled_P.C4;
  acker_steer_angles_idx_0 = mu_x_0 * untitled_P.Constant1_Value[1];
  n_idx_2 = kx_idx_1 * phi_fl / acker_steer_angles_idx_0;
  rtb_Fx_max_idx_1 = acker_steer_angles_idx_0;
  SL_idx_2 = ((rtb_Fx_max_idx_2 * untitled_P.C2 + untitled_P.C1 * rt_powd_snf
               (untitled_P.Constant1_Value[2], 3.0)) + untitled_P.C3 *
              untitled_P.Constant1_Value[2]) + untitled_P.C4;
  acker_steer_angles_idx_0 = mu_x_1 * untitled_P.Constant1_Value[2];
  n_idx_3 = kx_idx_2 * phi_rl / acker_steer_angles_idx_0;
  rtb_Fx_max_idx_2 = acker_steer_angles_idx_0;
  mu_y_1 = ((mu_x_tmp * untitled_P.C2 + untitled_P.C1 * rt_powd_snf
             (untitled_P.Constant1_Value[3], 3.0)) + untitled_P.C3 *
            untitled_P.Constant1_Value[3]) + untitled_P.C4;
  acker_steer_angles_idx_0 = mu_x_2 * untitled_P.Constant1_Value[3];
  mu_x_tmp = kx_idx_3 * rack_displacement / acker_steer_angles_idx_0;
  a_bar_tmp = tan(SA_idx_0);
  SA_idx_0 = C[0] * a_bar_tmp / (mu_y * untitled_P.Constant1_Value[0]);
  C_tmp = C[0] * mu_x / (acker_steer_angles_idx_1 * mu_y);
  n_idx_0 = 1.0;
  a_bar_idx_0 = SA_idx_0;
  max_current[0] = sqrt(n_idx_1 * n_idx_1 + SA_idx_0 * SA_idx_0);
  SA_fr = tan(SA_fr);
  SA_idx_0 = C[1] * SA_fr / (mu_y_0 * untitled_P.Constant1_Value[1]);
  ...
  SA_idx_0 = C[2] * SA_idx_2 / (SL_idx_2 * untitled_P.Constant1_Value[2]);
  ...
  SA_idx_0 = C[3] * SA_idx_3 / (mu_y_1 * untitled_P.Constant1_Value[3]);
  ...
  for (low_i = 0; low_i < 4; low_i++) {
    ...
    rtb_FY[low_i] = 0.0;
    C[low_i] = exp(untitled_P.b * max_current[low_i]) * untitled_P.a + exp
      (untitled_P.d * max_current[low_i]) * untitled_P.c;
  }
  ...
  if (fabs(mu_x_tmp) < 0.001) {
    rtb_TmpSignalConversionAtSFun_0[0] = untitled_P.Constant_Value;
    rtb_TmpSignalConversionAtSFun_0[1] = untitled_P.Constant_Value;
    if (untitled_norm(rtb_TmpSignalConversionAtSFun_0) < 3.0) {
    } else {
      rtb_FY[0] = n_idx_0 * C[0] * a_bar_tmp * mu_y *
        untitled_P.Constant1_Value[0] / mu_x_tmp;
    }
  } else {
    rtb_FY[0] = n_idx_0 * C[0] * a_bar_tmp * mu_y * untitled_P.Constant1_Value[0]
      / mu_x_tmp;
  }
  ...
  if (fabs(mu_x_tmp) < 0.001) {
    ...
    if (untitled_norm(rtb_TmpSignalConversionAtSFun_0) < 3.0) {
      ...
      rtb_FY[1] = n_idx_1 * C[1] * SA_fr * mu_y_0 * untitled_P.Constant1_Value[1]
        / mu_x_tmp;
    }
  } else {
    rtb_FY[1] = n_idx_1 * C[1] * SA_fr * mu_y_0 * untitled_P.Constant1_Value[1] /
  ...
  if (fabs(mu_x_tmp) < 0.001) {
    ...
    if (untitled_norm(rtb_TmpSignalConversionAtSFun_0) < 3.0) {
      ...
      rtb_FY[2] = n_idx_2 * C[2] * SA_idx_2 * SL_idx_2 *
        untitled_P.Constant1_Value[2] / mu_x_tmp;
    }
  } else {
    rtb_FY[2] = n_idx_2 * C[2] * SA_idx_2 * SL_idx_2 *
      untitled_P.Constant1_Value[2] / mu_x_tmp;
  ...
  if (fabs(mu_x_tmp) < 0.001) {
    ...
    if (untitled_norm(rtb_TmpSignalConversionAtSFun_0) < 3.0) {
      ...
      rtb_FY[3] = n_idx_3 * C[3] * SA_idx_3 * mu_y_1 *
        untitled_P.Constant1_Value[3] / mu_x_tmp;
    }
  } else {
    rtb_FY[3] = n_idx_3 * C[3] * SA_idx_3 * mu_y_1 * untitled_P.Constant1_Value
      [3] / mu_x_tmp;
  }
  ...
  if (fabs(k_tmp) <= 6.2831853071795862) {
    mu_x_tmp = cos(untitled_P.k_limit / 2.0) * 0.5;
  ...
  mu_y = 0.0;
  if (untitled_P.k_limit > fabs(a_bar_idx_0)) {
    mu_y = sqrt(untitled_P.k_limit * untitled_P.k_limit - a_bar_idx_0 *
                a_bar_idx_0);
  }

  mu_y = mu_y * mu_x * untitled_P.Constant1_Value[0] / acker_steer_angles_idx_1;
  mu_x = exp(untitled_P.b * untitled_P.k_limit) * untitled_P.a + exp
    (untitled_P.d * untitled_P.k_limit) * untitled_P.c;
  acker_steer_angles_idx_1 = mu_x * rtb_Fx_max_idx_0 * mu_y / sqrt(n_idx_1 *
    n_idx_1 * mu_x_tmp_tmp + mu_y * mu_y);
  mu_y = 0.0;
  if (untitled_P.k_limit > fabs(a_bar_idx_1)) {
    mu_y = sqrt(untitled_P.k_limit * untitled_P.k_limit - a_bar_idx_1 *
                a_bar_idx_1);
  }

  mu_y = mu_y * mu_x_0 * untitled_P.Constant1_Value[1] / kx_idx_1;
  kx_idx_1 = mu_x * rtb_Fx_max_idx_1 * mu_y / sqrt(n_idx_2 * n_idx_2 *
    left_steering_angle + mu_y * mu_y);
  mu_y = 0.0;
  if (untitled_P.k_limit > fabs(a_bar_idx_2)) {
    mu_y = sqrt(untitled_P.k_limit * untitled_P.k_limit - a_bar_idx_2 *
                a_bar_idx_2);
  }

  mu_y = mu_y * mu_x_1 * untitled_P.Constant1_Value[2] / kx_idx_2;
  kx_idx_2 = mu_x * rtb_Fx_max_idx_2 * mu_y / sqrt(n_idx_3 * n_idx_3 * phi_fl +
    mu_y * mu_y);
  mu_y = 0.0;
  if (untitled_P.k_limit > fabs(SA_idx_0)) {
    mu_y = sqrt(untitled_P.k_limit * untitled_P.k_limit - k_tmp_tmp);
  }

  mu_y = mu_y * mu_x_2 * untitled_P.Constant1_Value[3] / kx_idx_3;
  ...
  for (low_ip1 = 0; low_ip1 <= 6; low_ip1 += 2) {
    /* MATLAB Function: '<S1>/Reference Generation' */
    tmp_3 = _mm_sub_pd(_mm_loadu_pd(&untitled_P.V_target[low_ip1 + 1]),
                       _mm_loadu_pd(&untitled_P.V_target[low_ip1]));
    _mm_storeu_pd(&del[low_ip1], _mm_div_pd(_mm_sub_pd(_mm_loadu_pd
      (&untitled_P.max_yaw_field[low_ip1 + 1]), _mm_loadu_pd
      (&untitled_P.max_yaw_field[low_ip1])), tmp_3));
    _mm_storeu_pd(&h[low_ip1], tmp_3);
  }

  /* MATLAB Function: '<S1>/Reference Generation' */
  for (low_ip1 = 8; low_ip1 < 9; low_ip1++) {
    phi_fl = untitled_P.V_target[low_ip1 + 1] - untitled_P.V_target[low_ip1];
    del[low_ip1] = (untitled_P.max_yaw_field[low_ip1 + 1] -
                    untitled_P.max_yaw_field[low_ip1]) / phi_fl;
    h[low_ip1] = phi_fl;
  }
  ...
  for (low_i = 0; low_i <= 6; low_i += 2) {
    ...
    _mm_storeu_pd(&pp_coefs[low_i + 27], _mm_loadu_pd
                  (&untitled_P.max_yaw_field[low_i]));
  }
  ...
  for (low_i = 8; low_i < 9; low_i++) {
    ...
    pp_coefs[low_i + 27] = untitled_P.max_yaw_field[low_i];
  }
  ...
  if (rtIsNaN(left_steering_angle)) {
    ...
    while (high_i > low_ip1) {
      int32_T mid_i;
      mid_i = ((low_i + high_i) + 1) >> 1;
      if (left_steering_angle >= untitled_P.V_target[mid_i - 1]) {
        low_i = mid_i - 1;
        low_ip1 = mid_i + 1;
      } else {
        high_i = mid_i;
    ...
    phi_rl = left_steering_angle - untitled_P.V_target[low_i];
  ...
  left_steering_angle = left_steering_angle * rtb_steering_idx_0 /
    (left_steering_angle * left_steering_angle * untitled_P.Ku + (untitled_P.l[0]
      + untitled_P.l[1]));
   ...
   *  Constant: '<Root>/Constant'
   */
  left_steering_angle -= untitled_P.Constant_Value;

  /* UnitDelay: '<S1>/Unit Delay4' */
  rack_displacement = untitled_DW.UnitDelay4_DSTATE;

  /* DiscreteIntegrator: '<S5>/Discrete-Time Integrator' incorporates:
   *  UnitDelay: '<S1>/Unit Delay4'
   */
  if ((untitled_DW.UnitDelay4_DSTATE <= 0.0) &&
      (untitled_DW.DiscreteTimeIntegrator_PrevRese == 1)) {
   ...
   */
  phi_rl = untitled_P.I * left_steering_angle * untitled_DW.UnitDelay_DSTATE *
   ...
   */
  if ((untitled_DW.UnitDelay4_DSTATE <= 0.0) &&
      (untitled_DW.DiscreteTimeIntegrator2_PrevRes == 1)) {
    untitled_DW.DiscreteTimeIntegrator2_DSTATE =
      untitled_P.DiscreteTimeIntegrator2_IC;
  }
   ...
   */
  phi_fl = (untitled_DW.UnitDelay1_DSTATE - untitled_P.Constant_Value) *
    untitled_P.T * untitled_DW.UnitDelay_DSTATE *
    untitled_P.DiscreteTimeIntegrator2_gainval +
    untitled_DW.DiscreteTimeIntegrator2_DSTATE;
   ...
   *  UnitDelay: '<S1>/Unit Delay4'
   */
  SA_fr = (untitled_P.P * left_steering_angle * untitled_DW.UnitDelay4_DSTATE +
           phi_rl) + phi_fl;
  ...
  n_idx_1 = untitled_P.s[0] * rtb_steering_idx_0 + untitled_P.l[0] *
    left_steering_angle;
  n_idx_2 = -untitled_P.s[0] * x_tmp + untitled_P.l[0] * rtb_steering_idx_1;
  rtb_steering_idx_2 = exp(-untitled_P.t / untitled_P.tau);
  slip_limit_idx_0 = (real32_T)(acker_steer_angles_idx_1 - rtb_T_brake_idx_0 /
    untitled_P.RE) / untitled_P.T2F[0];
  mu_x_2 = untitled_P.Constant_Value * untitled_P.gr[0];
  mu_x_1 = untitled_P.motor_limit_power[0] * untitled_P.motor_efficiency[0] /
    mu_x_2;
  if (mu_x_1 > 25.0) {
    mu_x_1 = 25.0;
  } else if ((mu_x_1 < -25.0) && (mu_x_2 > untitled_P.min_speed_regen)) {
    mu_x_1 = -25.0;
  ...
  mu_x_0 = untitled_P.Constant_Value * rtb_steering_idx_2;
  SA_idx_3 = (1.0 - rtb_steering_idx_2) * untitled_P.motor_limit_torque[1] +
    mu_x_0;
  ...
  rtb_steering_idx_2 = (1.0 - rtb_steering_idx_2) *
    untitled_P.motor_limit_torque[0] + mu_x_0;
  rtb_Fx_max_idx_0 = rtb_steering_idx_2;
  rtb_T_brake_idx_0 = mu_x_2;
  SA_idx_0 = mu_x_1;
  C[0] = mu_y_0;
  slip_limit_idx_1 = (real32_T)(kx_idx_1 - rtb_T_brake_idx_1 / untitled_P.RE) /
    untitled_P.T2F[1];
  mu_x_2 = untitled_P.Constant_Value * untitled_P.gr[1];
  mu_x_1 = untitled_P.motor_limit_power[1] * untitled_P.motor_efficiency[1] /
    mu_x_2;
  if (mu_x_1 > 25.0) {
    mu_x_1 = 25.0;
  } else if ((mu_x_1 < -25.0) && (mu_x_2 > untitled_P.min_speed_regen)) {
  ...
  C[1] = mu_y_0;
  slip_limit_idx_2 = (real32_T)(kx_idx_2 - rtb_T_brake_idx_2 / untitled_P.RE) /
    untitled_P.T2F[2];
  mu_x_2 = untitled_P.Constant_Value * untitled_P.gr[2];
  mu_x_1 = untitled_P.motor_limit_power[2] * untitled_P.motor_efficiency[2] /
    mu_x_2;
  if (mu_x_1 > 25.0) {
    mu_x_1 = 25.0;
  } else if ((mu_x_1 < -25.0) && (mu_x_2 > untitled_P.min_speed_regen)) {
  ...
  slip_limit_idx_3 = (real32_T)(mu_x * acker_steer_angles_idx_0 * mu_y / sqrt
    ...
    untitled_P.RE) / untitled_P.T2F[3];
  mu_x_2 = untitled_P.Constant_Value * untitled_P.gr[3];
  mu_x_1 = untitled_P.motor_limit_power[3] * untitled_P.motor_efficiency[3] /
    mu_x_2;
  if (mu_x_1 > 25.0) {
    mu_x_1 = 25.0;
  } else if ((mu_x_1 < -25.0) && (mu_x_2 > untitled_P.min_speed_regen)) {
  ...
  c_x[2] = (real32_T)untitled_P.motor_limit_torque[1];
  ...
  lb_f[2] = (real32_T)untitled_P.motor_limit_torque[0];
  ...
  if ((rtb_T_brake_idx_0 < untitled_P.min_speed_regen) && (slip_limit_idx_0 <
       0.0F)) {
  ...
  if ((rtb_T_brake_idx_1 < untitled_P.min_speed_regen) && (slip_limit_idx_1 <
       0.0F)) {
  ...
  if ((rtb_T_brake_idx_2 < untitled_P.min_speed_regen) && (slip_limit_idx_2 <
       0.0F)) {
  ...
  if ((mu_x_2 < untitled_P.min_speed_regen) && (rtb_lb_idx_3 < 0.0F)) {
    rtb_lb_idx_3 = 0.001F;
  }

  slip_limit_idx_3 = (real32_T)((((-untitled_P.s[0] * left_steering_angle +
    untitled_P.l[0] * rtb_steering_idx_0) * (rtb_FY[0] * untitled_P.mu_factor) +
    (untitled_P.s[0] * rtb_steering_idx_1 + untitled_P.l[0] * x_tmp) * (rtb_FY[1]
    * untitled_P.mu_factor)) + rtb_FY[2] * untitled_P.mu_factor * -untitled_P.l
    [1]) + rtb_FY[3] * untitled_P.mu_factor * -untitled_P.l[1]);
  rtb_lb_idx_3 = ((((rtb_ub_idx_0 * untitled_P.T2F[0] * (real32_T)n_idx_1 +
                     rtb_ub_idx_2 * untitled_P.T2F[2] * (real32_T)untitled_P.s[1])
                    + slip_limit_idx_1 * untitled_P.T2F[1] * (real32_T)n_idx_2)
                   + rtb_lb_idx_3 * untitled_P.T2F[3] * (real32_T)-untitled_P.s
                   [1]) + slip_limit_idx_3) / (real32_T)untitled_P.J_z;
  rtb_ub_idx_0 = ((((rtb_ub_idx_1 * untitled_P.T2F[1] * (real32_T)n_idx_2 +
                     rtb_ub_idx_3 * untitled_P.T2F[3] * (real32_T)-untitled_P.s
                     [1]) + slip_limit_idx_0 * untitled_P.T2F[0] * (real32_T)
                    n_idx_1) + slip_limit_idx_2 * untitled_P.T2F[2] * (real32_T)
                   untitled_P.s[1]) + slip_limit_idx_3) / (real32_T)
    untitled_P.J_z;
  ...
  if ((untitled_P.Constant_Value < untitled_P.min_speed_regen) &&
      (untitled_P.Constant_Value <= 0.0)) {
    SA_fr = 0.0;
  }

  if (untitled_DW.UnitDelay3_DSTATE < 0.0) {
    x_tmp = -1.0;
  } else if (untitled_DW.UnitDelay3_DSTATE > 0.0) {
    x_tmp = 1.0;
  } else if (untitled_DW.UnitDelay3_DSTATE == 0.0) {
    x_tmp = 0.0;
  } else {
  ...
  if (rack_displacement > 0.0) {
    ...
    if (rack_displacement < 0.0) {
      ...
      untitled_DW.DiscreteTimeIntegrator_PrevRese = 0;
    } else {
    ...
    if (rack_displacement < 0.0) {
      ...
      untitled_DW.DiscreteTimeIntegrator2_PrevRes = 0;
    } else {
      untitled_DW.DiscreteTimeIntegrator2_PrevRes = 2;
    }
  }
   ...
   *  MATLAB Function: '<S1>/Constraint Generation'
   */
  untitled_DW.UnitDelay1_DSTATE = SA_fr;

  /* Update for DiscreteIntegrator: '<S5>/Discrete-Time Integrator2' */
  untitled_DW.DiscreteTimeIntegrator2_DSTATE = phi_fl;

  /* Update for UnitDelay: '<S1>/Unit Delay3' incorporates:
   *  Constant: '<Root>/Constant'
   */
  untitled_DW.UnitDelay3_DSTATE = untitled_P.Constant_Value;
...
void untitled_initialize(void)
{
  ...
  rtmSetTFinal(untitled_M, 9.99);
  untitled_M->Timing.stepSize0 = 0.015;
  ...
  untitled_DW.UnitDelay4_DSTATE = untitled_P.UnitDelay4_InitialCondition;
  ...
  untitled_DW.UnitDelay3_DSTATE = untitled_P.UnitDelay3_InitialCondition;
}
