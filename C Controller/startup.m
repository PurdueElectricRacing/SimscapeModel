...
%% Tunable Parameters
tire_mu = Simulink.Parameter(1.8); % Friction coefficient for max allowed yaw [1x1][unitless]
...
yaw_factor = Simulink.Parameter(0.36); % Factor to control yaw magnitude [1x1][unitless]
...
%% Tire Models
% kx model
A1 = Simulink.Parameter(50.76);
A2 = Simulink.Parameter(1526);
