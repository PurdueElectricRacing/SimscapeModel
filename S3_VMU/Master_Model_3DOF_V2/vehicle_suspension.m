...
function [xS, yS, zS, dxS, dzS, xT, yT, zT] = vehicle_suspension(s, model)
    % get states
    dza = s(3);
    za = s(4);
    ...
    dzS = dz0 + wb_s_actual.*dpitch.*[1;1;-1;-1];
