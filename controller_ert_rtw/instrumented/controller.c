...
void controller_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    if (zcEvent != NO_ZCEVENT) {
      ...
      /* Sqrt: '<S8>/Sqrt' */
      profileStart_controller(1U); /* original_line:777 */rtb_ElementProduct_idx_4 = sqrt(rtb_Tx_guess_idx_3);profileEnd_controller(1U); /* original_line:777 */
      ...
      profileStart_controller(2U); /* original_line:838 */rtb_Tx_guess_idx_3 = acos(rtb_ElementProduct_idx_4);profileEnd_controller(2U); /* original_line:838 */
       ...
       */
      profileStart_controller(3U); /* original_line:845 */rtb_MaxIndividualMotorTorqueN_0 = cos(rtb_Tx_guess_idx_3);profileEnd_controller(3U); /* original_line:845 */
      rtb_Bias = rtb_MaxIndividualMotorTorqueN_0;

      /* Trigonometry: '<S9>/Sin' */
      profileStart_controller(4U); /* original_line:849 */rtb_Sin = sin(rtb_Tx_guess_idx_3);profileEnd_controller(4U); /* original_line:849 */
      ...
      if (rtb_ElementProduct_idx_4 < 0.0) {
        profileStart_controller(6U); /* original_line:867 */rtb_ElementProduct_idx_4 = -sqrt(fabs(rtb_ElementProduct_idx_4));profileEnd_controller(6U); /* original_line:867 */
      } else {
        profileStart_controller(5U); /* original_line:869 */rtb_ElementProduct_idx_4 = sqrt(rtb_ElementProduct_idx_4);profileEnd_controller(5U); /* original_line:869 */
      }
    ...
    profileStart_controller(7U); /* original_line:988 */rtb_Sin = fmax(rtb_Sin, rtU->MotorTemeprature0100degC14[1]);profileEnd_controller(7U); /* original_line:988 */

    /* Lookup_n-D: '<S5>/Temperature to Motor Current Limit Map' incorporates:
     *  CCaller: '<S5>/C Caller'
     */
    profileStart_controller(8U); /* original_line:993 */bpIdx = plook_evenca(rtb_Sin, 75.0, 25.0, 1U, &rtb_ElementProduct_idx_4);profileEnd_controller(8U); /* original_line:993 */
    profileStart_controller(9U); /* original_line:994 */rtb_Sin = intrp1d_la(bpIdx, rtb_ElementProduct_idx_4, rtConstP.pooled6, 1U);profileEnd_controller(9U); /* original_line:994 */

    /* MinMax: '<S5>/Max1' */
    rtb_Bias = rtU->MotorControlerTemeprature075deg[0];
    profileStart_controller(10U); /* original_line:998 */rtb_Bias = fmax(rtb_Bias, rtU->MotorControlerTemeprature075deg[1]);profileEnd_controller(10U); /* original_line:998 */

    /* Lookup_n-D: '<S5>/Temperature to MC Current Limit Map' incorporates:
     *  CCaller: '<S5>/C Caller'
     */
    profileStart_controller(11U); /* original_line:1003 */bpIdx = plook_evenca(rtb_Bias, 50.0, 25.0, 1U, &rtb_ElementProduct_idx_4);profileEnd_controller(11U); /* original_line:1003 */
    profileStart_controller(12U); /* original_line:1004 */rtb_Bias = intrp1d_la(bpIdx, rtb_ElementProduct_idx_4, rtConstP.pooled6, 1U);profileEnd_controller(12U); /* original_line:1004 */

    /* Lookup_n-D: '<S5>/1-D Lookup Table2' incorporates:
     *  Sum: '<S5>/Sum4'
     */
    profileStart_controller(13U); /* original_line:1009 */bpIdx = plook_evenc(rtU->MaxDischargeChargeCurrent0150A1[0] -
                        rtU->BatteryCurrent0150A11, 0.0, 5.0, 1U,
                        &rtb_ElementProduct_idx_4);profileEnd_controller(13U); /* original_line:1011 */
     ...
     *  Sum: '<S5>/Sum2'
     */
    profileStart_controller(14U); /* original_line:1018 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(((rtb_AllMomentArmsFLFRRLRRabou_2 +
      rtb_AllMomentArmsFLFRRLRRabou_2) + rtb_Tx_guess_idx_3) +
      rtb_Tx_guess_idx_3, rtb_Sin);profileEnd_controller(14U); /* original_line:1020 */
    profileStart_controller(15U); /* original_line:1021 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(rtb_AllMomentArmsFLFRRLRRabou_2,
      rtb_Bias);profileEnd_controller(15U); /* original_line:1022 */
    profileStart_controller(16U); /* original_line:1023 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(rtb_AllMomentArmsFLFRRLRRabou_2,
      intrp1d_l(bpIdx, rtb_ElementProduct_idx_4,
                rtConstP.uDLookupTable2_tableData));profileEnd_controller(16U); /* original_line:1025 */

    /* Gain: '<S5>/Gain4' */
    rtb_ElementProduct_idx_4 = 0.5 * rtb_AllMomentArmsFLFRRLRRabou_2;

    /* Abs: '<S5>/Abs1' */
    profileStart_controller(17U); /* original_line:1031 */rtb_Bias = fabs(rtU->steering_angle_deg);profileEnd_controller(17U); /* original_line:1031 */
     ...
     *  Sqrt: '<S2>/Sqrt'
     */
    profileStart_controller(18U); /* original_line:1044 */rtb_Bias = look2_binlc(sqrt(rtU->vel[0] * rtU->vel[0] + rtU->vel[1] *
      rtU->vel[1]), rtb_Bias, rtConstP.uDLookupTable_bp01Data,
      rtConstP.uDLookupTable_bp02Data, rtConstP.uDLookupTable_tableData,
      rtConstP.uDLookupTable_maxIndex, 34U);profileEnd_controller(18U); /* original_line:1047 */
    ...
    profileStart_controller(19U); /* original_line:1111 */rtb_AllMomentArmsFLFRRLRRabou_0 = look1_binlc(rtU->steering_angle_deg,
      rtConstP.pooled8, rtConstP.uDLookupTable_tableData_c, 260U);profileEnd_controller(19U); /* original_line:1112 */

    /* Lookup_n-D: '<S5>/1-D Lookup Table1' */
    profileStart_controller(20U); /* original_line:1115 */rtb_FRMomentArm = look1_binlc(rtU->steering_angle_deg, rtConstP.pooled8,
      rtConstP.uDLookupTable1_tableData, 260U);profileEnd_controller(20U); /* original_line:1116 */
    ...
    if (rtb_AllMomentArmsFLFRRLRRabou_1 > 0.0) {
      ...
      profileStart_controller(21U); /* original_line:1124 */rtb_ElementProduct_idx_4 = (rtb_MathFunction_idx_1 - fabs
        (rtb_AllMomentArmsFLFRRLRRabou_1 / 0.621)) + 25.0;profileEnd_controller(21U); /* original_line:1125 */
    ...
    rtb_Bias = 25.0;
    rtb_Sin = 25.0;
    profileStart_controller(22U); /* original_line:1146 */rtb_exitflag = bigM_func(39.2280863132881, 39.2280863132881,
      ...
      0.020000000000000004);profileEnd_controller(22U); /* original_line:1156 */
    ...
    if (rtb_exitflag == 3) {
       ...
       *  Lookup_n-D: '<S4>/k_min'
       */
      profileStart_controller(23U); /* original_line:1183 */bpIndices[1U] = plook_evenc(rtU->BatteryTerminalVoltage0340V11, 60.0,
        11.200000000000003, 25U, &rtb_ElementProduct_idx_4);profileEnd_controller(23U); /* original_line:1184 */
      fractions[1U] = rtb_ElementProduct_idx_4;
      profileStart_controller(24U); /* original_line:1186 */bpIndices[0U] = plook_evenc(rtU->omega_m[0], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(24U); /* original_line:1187 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(25U); /* original_line:1189 */rtb_Bias = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData, 107U);profileEnd_controller(25U); /* original_line:1189 */
      profileStart_controller(26U); /* original_line:1190 */bpIndices[0U] = plook_evenc(rtU->omega_m[1], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(26U); /* original_line:1191 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(27U); /* original_line:1193 */rtb_Sin = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData, 107U);profileEnd_controller(27U); /* original_line:1193 */
      profileStart_controller(28U); /* original_line:1194 */bpIndices[0U] = plook_evenc(rtU->omega_m[2], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(28U); /* original_line:1195 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(29U); /* original_line:1197 */rtb_Tx_guess_idx_3 = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData,
        107U);profileEnd_controller(29U); /* original_line:1198 */
      profileStart_controller(30U); /* original_line:1199 */bpIndices[0U] = plook_evenc(rtU->omega_m[3], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(30U); /* original_line:1200 */
      fractions[0U] = rtb_ElementProduct_idx_4;
       ...
       *  Inport: '<Root>/omega_m'
       */
      profileStart_controller(31U); /* original_line:1215 */bpIndices_0[1U] = plook_evenc(rtU->BatteryTerminalVoltage0340V11, 60.0,
        11.200000000000003, 25U, &rtb_ElementProduct_idx_4);profileEnd_controller(31U); /* original_line:1216 */
      fractions_0[1U] = rtb_ElementProduct_idx_4;
      profileStart_controller(32U); /* original_line:1218 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[0], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(32U); /* original_line:1219 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(33U); /* original_line:1221 */rtb_Bias = intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData,
                           107U);profileEnd_controller(33U); /* original_line:1222 */
      profileStart_controller(34U); /* original_line:1223 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[1], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(34U); /* original_line:1224 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(35U); /* original_line:1226 */rtb_Sin = intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData,
                          107U);profileEnd_controller(35U); /* original_line:1227 */
      profileStart_controller(36U); /* original_line:1228 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[2], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(36U); /* original_line:1229 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(37U); /* original_line:1231 */rtb_Tx_guess_idx_3 = intrp2d_l(bpIndices_0, fractions_0,
        rtConstP.k_min_tableData, 107U);profileEnd_controller(37U); /* original_line:1232 */
      profileStart_controller(38U); /* original_line:1233 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[3], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(38U); /* original_line:1234 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      rtb_AllMomentArmsFLFRRLRRabou_0 += rtb_Bias;
      rtb_AllMomentArmsFLFRRLRRabou_1 += rtb_Sin;
      rtb_AllMomentArmsFLFRRLRRabou_2 += rtb_Tx_guess_idx_3;
      profileStart_controller(39U); /* original_line:1239 */rtb_ElementProduct_idx_4 = intrp2d_l(bpIndices, fractions,
        rtConstP.dk_tableData, 107U) * rtb_MaxIndividualMotorTorqueNm_ +
        intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData, 107U);profileEnd_controller(39U); /* original_line:1241 */
    } else {
...
void controller_initialize(RT_MODEL *const rtM)
{
...

  {
    ...
    profileStart_controller(40U); /* original_line:1374 */SystemCore_setup(&rtDW->obj);profileEnd_controller(40U); /* original_line:1374 */
    ...
    profileStart_controller(41U); /* original_line:1388 */memcpy(&rtDW->IdentityMatrix[0], &rtConstP.IdentityMatrix_IDMatrixData[0],
           9U * sizeof(real_T));profileEnd_controller(41U); /* original_line:1389 */
