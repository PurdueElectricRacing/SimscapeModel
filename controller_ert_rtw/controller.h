...
typedef struct {
  real_T driver_input;                 /* '<Root>/T' */
  real_T steering_angle_deg;           /* '<Root>/phi' */
  real_T gyro[3];                      /* '<Root>/ang_vel_s' */
  real_T vel[3];                       /* '<Root>/vel_NED' */
  real_T omega_m[4];                   /* '<Root>/omega_m' */
  real_T MaxDischargeChargeCurrent0150A1[2];/* '<Root>/i_max' */
  real_T MotorControlerTemeprature075deg[2];/* '<Root>/T_mc_RAW' */
  real_T MotorTemeprature0100degC14[2];/* '<Root>/T_m_RAW' */
  real_T GPSfixtype03state11;          /* '<Root>/S' */
  real_T DataIDforeachsignal110[10];   /* '<Root>/ID1' */
  real_T FlagIndicatingHVON01;         /* '<Root>/HV_ON' */
  real_T FlagIndicatingReadytoDrive01; /* '<Root>/R2D' */
  real_T acc[3];                       /* '<Root>/accel_s' */
  real_T deadbandonthetadeg11;         /* '<Root>/dphi' */
  real_T intensityfactoronyawratereferen;/* '<Root>/TVS_I' */
  real_T BatteryTerminalVoltage0340V11;/* '<Root>/Vb' */
  real_T BatteryCurrent0150A11;        /* '<Root>/Ib' */
} ExtU;
