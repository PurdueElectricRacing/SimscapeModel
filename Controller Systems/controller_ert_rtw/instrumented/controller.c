...
void controller_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    if (zcEvent != NO_ZCEVENT) {
      ...
      /* Sqrt: '<S8>/Sqrt' */
      profileStart_controller(1U); /* original_line:776 */rtb_ElementProduct_idx_4 = sqrt(rtb_Tx_guess_idx_3);profileEnd_controller(1U); /* original_line:776 */
      ...
      profileStart_controller(2U); /* original_line:837 */rtb_Tx_guess_idx_3 = acos(rtb_ElementProduct_idx_4);profileEnd_controller(2U); /* original_line:837 */
       ...
       */
      profileStart_controller(3U); /* original_line:844 */rtb_MaxIndividualMotorTorqueN_0 = cos(rtb_Tx_guess_idx_3);profileEnd_controller(3U); /* original_line:844 */
      rtb_Bias = rtb_MaxIndividualMotorTorqueN_0;

      /* Trigonometry: '<S9>/Sin' */
      profileStart_controller(4U); /* original_line:848 */rtb_Sin = sin(rtb_Tx_guess_idx_3);profileEnd_controller(4U); /* original_line:848 */
      ...
      if (rtb_ElementProduct_idx_4 < 0.0) {
        profileStart_controller(6U); /* original_line:866 */rtb_ElementProduct_idx_4 = -sqrt(fabs(rtb_ElementProduct_idx_4));profileEnd_controller(6U); /* original_line:866 */
      } else {
        profileStart_controller(5U); /* original_line:868 */rtb_ElementProduct_idx_4 = sqrt(rtb_ElementProduct_idx_4);profileEnd_controller(5U); /* original_line:868 */
      }
    ...
    rtb_AllMomentArmsFLFRRLRRabou_2 = 0.0 * rtU->T;
    ...
    /* MinMax: '<S5>/Max' */
    rtb_Sin = rtU->T_m_RAW[0];
    profileStart_controller(7U); /* original_line:987 */rtb_Sin = fmax(rtb_Sin, rtU->T_m_RAW[1]);profileEnd_controller(7U); /* original_line:987 */

    /* Lookup_n-D: '<S5>/Temperature to Motor Current Limit Map' incorporates:
     *  CCaller: '<S5>/C Caller'
     */
    profileStart_controller(8U); /* original_line:992 */bpIdx = plook_evenca(rtb_Sin, 75.0, 25.0, 1U, &rtb_ElementProduct_idx_4);profileEnd_controller(8U); /* original_line:992 */
    profileStart_controller(9U); /* original_line:993 */rtb_Sin = intrp1d_la(bpIdx, rtb_ElementProduct_idx_4, rtConstP.pooled6, 1U);profileEnd_controller(9U); /* original_line:993 */

    /* MinMax: '<S5>/Max1' */
    rtb_Bias = rtU->T_mc_RAW[0];
    profileStart_controller(10U); /* original_line:997 */rtb_Bias = fmax(rtb_Bias, rtU->T_mc_RAW[1]);profileEnd_controller(10U); /* original_line:997 */

    /* Lookup_n-D: '<S5>/Temperature to MC Current Limit Map' incorporates:
     *  CCaller: '<S5>/C Caller'
     */
    profileStart_controller(11U); /* original_line:1002 */bpIdx = plook_evenca(rtb_Bias, 50.0, 25.0, 1U, &rtb_ElementProduct_idx_4);profileEnd_controller(11U); /* original_line:1002 */
    profileStart_controller(12U); /* original_line:1003 */rtb_Bias = intrp1d_la(bpIdx, rtb_ElementProduct_idx_4, rtConstP.pooled6, 1U);profileEnd_controller(12U); /* original_line:1003 */

    /* Lookup_n-D: '<S5>/1-D Lookup Table2' incorporates:
     *  Sum: '<S5>/Sum4'
     */
    profileStart_controller(13U); /* original_line:1008 */bpIdx = plook_evenc(rtU->i_max[0] - rtU->Ib, 0.0, 5.0, 1U,
                        &rtb_ElementProduct_idx_4);profileEnd_controller(13U); /* original_line:1009 */
     ...
     *  Sum: '<S5>/Sum2'
     */
    profileStart_controller(14U); /* original_line:1016 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(((rtb_AllMomentArmsFLFRRLRRabou_2 +
      rtb_AllMomentArmsFLFRRLRRabou_2) + rtb_Tx_guess_idx_3) +
      rtb_Tx_guess_idx_3, rtb_Sin);profileEnd_controller(14U); /* original_line:1018 */
    profileStart_controller(15U); /* original_line:1019 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(rtb_AllMomentArmsFLFRRLRRabou_2,
      rtb_Bias);profileEnd_controller(15U); /* original_line:1020 */
    profileStart_controller(16U); /* original_line:1021 */rtb_AllMomentArmsFLFRRLRRabou_2 = fmin(rtb_AllMomentArmsFLFRRLRRabou_2,
      intrp1d_l(bpIdx, rtb_ElementProduct_idx_4,
                rtConstP.uDLookupTable2_tableData));profileEnd_controller(16U); /* original_line:1023 */

    /* Gain: '<S5>/Gain4' */
    rtb_ElementProduct_idx_4 = 0.5 * rtb_AllMomentArmsFLFRRLRRabou_2;

    /* Abs: '<S5>/Abs1' */
    profileStart_controller(17U); /* original_line:1029 */rtb_Bias = fabs(rtU->phi);profileEnd_controller(17U); /* original_line:1029 */

    /* RelationalOperator: '<S5>/GreaterThan' */
    rtb_Equal = (rtb_Bias > rtU->dphi);

    /* Product: '<S5>/Product3' */
    rtb_Bias = rtU->phi * (real_T)rtb_Equal;
     ...
     *  Sqrt: '<S2>/Sqrt'
     */
    profileStart_controller(18U); /* original_line:1042 */rtb_Bias = look2_binlc(sqrt(rtU->vel[0] * rtU->vel[0] + rtU->vel[1] *
      rtU->vel[1]), rtb_Bias, rtConstP.uDLookupTable_bp01Data,
      rtConstP.uDLookupTable_bp02Data, rtConstP.uDLookupTable_tableData,
      rtConstP.uDLookupTable_maxIndex, 34U);profileEnd_controller(18U); /* original_line:1045 */
     ...
     *  Sum: '<S5>/Sum1'
     */
    rtb_Bias = (rtb_Product_e[2] - rtU->TVV_I * rtb_Bias) * 20.0;
    ...
    profileStart_controller(19U); /* original_line:1108 */rtb_AllMomentArmsFLFRRLRRabou_0 = look1_binlc(rtU->phi, rtConstP.pooled8,
      rtConstP.uDLookupTable_tableData_c, 260U);profileEnd_controller(19U); /* original_line:1109 */

    /* Lookup_n-D: '<S5>/1-D Lookup Table1' */
    profileStart_controller(20U); /* original_line:1112 */rtb_FRMomentArm = look1_binlc(rtU->phi, rtConstP.pooled8,
      rtConstP.uDLookupTable1_tableData, 260U);profileEnd_controller(20U); /* original_line:1113 */
    ...
    if (rtb_AllMomentArmsFLFRRLRRabou_1 > 0.0) {
      ...
      profileStart_controller(21U); /* original_line:1121 */rtb_ElementProduct_idx_4 = (rtb_MathFunction_idx_1 - fabs
        (rtb_AllMomentArmsFLFRRLRRabou_1 / 0.621)) + 25.0;profileEnd_controller(21U); /* original_line:1122 */
    ...
    rtb_Bias = 25.0;
    rtb_Sin = 25.0;
    profileStart_controller(22U); /* original_line:1143 */rtb_exitflag = bigM_func(39.2280863132881, 39.2280863132881,
      ...
      0.020000000000000004);profileEnd_controller(22U); /* original_line:1153 */
    ...
    if (rtb_exitflag == 3) {
       ...
       *  Lookup_n-D: '<S4>/k_min'
       */
      profileStart_controller(23U); /* original_line:1180 */bpIndices[1U] = plook_evenc(rtU->Vb, 60.0, 11.200000000000003, 25U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(23U); /* original_line:1181 */
      fractions[1U] = rtb_ElementProduct_idx_4;
      profileStart_controller(24U); /* original_line:1183 */bpIndices[0U] = plook_evenc(rtU->omega_m[0], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(24U); /* original_line:1184 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(25U); /* original_line:1186 */rtb_Bias = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData, 107U);profileEnd_controller(25U); /* original_line:1186 */
      profileStart_controller(26U); /* original_line:1187 */bpIndices[0U] = plook_evenc(rtU->omega_m[1], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(26U); /* original_line:1188 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(27U); /* original_line:1190 */rtb_Sin = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData, 107U);profileEnd_controller(27U); /* original_line:1190 */
      profileStart_controller(28U); /* original_line:1191 */bpIndices[0U] = plook_evenc(rtU->omega_m[2], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(28U); /* original_line:1192 */
      fractions[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(29U); /* original_line:1194 */rtb_Tx_guess_idx_3 = intrp2d_l(bpIndices, fractions, rtConstP.dk_tableData,
        107U);profileEnd_controller(29U); /* original_line:1195 */
      profileStart_controller(30U); /* original_line:1196 */bpIndices[0U] = plook_evenc(rtU->omega_m[3], 0.0, 10.404006451471698, 106U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(30U); /* original_line:1197 */
      fractions[0U] = rtb_ElementProduct_idx_4;
       ...
       *  Inport: '<Root>/omega_m'
       */
      profileStart_controller(31U); /* original_line:1212 */bpIndices_0[1U] = plook_evenc(rtU->Vb, 60.0, 11.200000000000003, 25U,
        &rtb_ElementProduct_idx_4);profileEnd_controller(31U); /* original_line:1213 */
      fractions_0[1U] = rtb_ElementProduct_idx_4;
      profileStart_controller(32U); /* original_line:1215 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[0], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(32U); /* original_line:1216 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(33U); /* original_line:1218 */rtb_Bias = intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData,
                           107U);profileEnd_controller(33U); /* original_line:1219 */
      profileStart_controller(34U); /* original_line:1220 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[1], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(34U); /* original_line:1221 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(35U); /* original_line:1223 */rtb_Sin = intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData,
                          107U);profileEnd_controller(35U); /* original_line:1224 */
      profileStart_controller(36U); /* original_line:1225 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[2], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(36U); /* original_line:1226 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      profileStart_controller(37U); /* original_line:1228 */rtb_Tx_guess_idx_3 = intrp2d_l(bpIndices_0, fractions_0,
        rtConstP.k_min_tableData, 107U);profileEnd_controller(37U); /* original_line:1229 */
      profileStart_controller(38U); /* original_line:1230 */bpIndices_0[0U] = plook_evenc(rtU->omega_m[3], 0.0, 10.404006451471698,
        106U, &rtb_ElementProduct_idx_4);profileEnd_controller(38U); /* original_line:1231 */
      fractions_0[0U] = rtb_ElementProduct_idx_4;
      rtb_AllMomentArmsFLFRRLRRabou_0 += rtb_Bias;
      rtb_AllMomentArmsFLFRRLRRabou_1 += rtb_Sin;
      rtb_AllMomentArmsFLFRRLRRabou_2 += rtb_Tx_guess_idx_3;
      profileStart_controller(39U); /* original_line:1236 */rtb_ElementProduct_idx_4 = intrp2d_l(bpIndices, fractions,
        rtConstP.dk_tableData, 107U) * rtb_MaxIndividualMotorTorqueNm_ +
        intrp2d_l(bpIndices_0, fractions_0, rtConstP.k_min_tableData, 107U);profileEnd_controller(39U); /* original_line:1238 */
    } else {
      rtb_AllMomentArmsFLFRRLRRabou_0 = rtU->T;
      rtb_AllMomentArmsFLFRRLRRabou_1 = rtU->T;
      rtb_AllMomentArmsFLFRRLRRabou_2 = rtU->T;
      rtb_ElementProduct_idx_4 = rtU->T;
    }
...
void controller_initialize(RT_MODEL *const rtM)
{
...

  {
    ...
    profileStart_controller(40U); /* original_line:1371 */SystemCore_setup(&rtDW->obj);profileEnd_controller(40U); /* original_line:1371 */
    ...
    profileStart_controller(41U); /* original_line:1385 */memcpy(&rtDW->IdentityMatrix[0], &rtConstP.IdentityMatrix_IDMatrixData[0],
           9U * sizeof(real_T));profileEnd_controller(41U); /* original_line:1386 */
