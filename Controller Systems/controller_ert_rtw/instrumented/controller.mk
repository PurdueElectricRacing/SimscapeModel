...
## Generated on : Sat Nov 18 12:50:54 2023
...
START_DIR                 = C:/Users/Inver/OneDrive/DOCUME~1/GitHub/SIMSCA~1/CONTRO~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
SRCS = $(START_DIR)/controller_ert_rtw/instrumented/controller.c $(START_DIR)/controller_ert_rtw/instrumented/controller_data.c coder_profile_timer.c
...
OBJS = controller.o controller_data.o coder_profile_timer.o
...
%.o : $(START_DIR)/controller_ert_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/controller_ert_rtw/instrumented/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_ert_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/controller_ert_rtw/instrumented/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controller_ert_rtw/instrumented/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


controller.o : $(START_DIR)/controller_ert_rtw/instrumented/controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


controller_data.o : $(START_DIR)/controller_ert_rtw/instrumented/controller_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/controller_ert_rtw/instrumented/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
