...
void controller_step(RT_MODEL *const rtM, ExtU *rtU, ExtY *rtY)
{
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    rtb_Sin = fmax(rtb_Sin, rtU->T_m_RAW[1]);
    ...
    rtb_Bias = fmax(rtb_Bias, rtU->T_mc_RAW[1]);
     ...
     *  Sum: '<S5>/Sum4'
     */
    bpIdx = plook_evenc(rtU->i_max[0] - rtU->Ib, 0.0, 5.0, 1U,
                        &rtb_ElementProduct_idx_4);
    ...
    rtb_AllMomentArmsFLFRRLRRabou_0 = look1_binlc(rtU->phi, rtConstP.pooled8,
      rtConstP.uDLookupTable_tableData_c, 260U);

    /* Lookup_n-D: '<S5>/1-D Lookup Table1' */
    rtb_FRMomentArm = look1_binlc(rtU->phi, rtConstP.pooled8,
    ...
    if (rtb_exitflag == 3) {
       ...
       *  Lookup_n-D: '<S4>/k_min'
       */
      bpIndices[1U] = plook_evenc(rtU->Vb, 60.0, 11.200000000000003, 25U,
        &rtb_ElementProduct_idx_4);
       ...
       *  Inport: '<Root>/omega_m'
       */
      bpIndices_0[1U] = plook_evenc(rtU->Vb, 60.0, 11.200000000000003, 25U,
        &rtb_ElementProduct_idx_4);
