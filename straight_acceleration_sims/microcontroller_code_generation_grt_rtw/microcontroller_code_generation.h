/*
 * microcontroller_code_generation.h
 *
...
#ifndef RTW_HEADER_microcontroller_code_generation_h_
#define RTW_HEADER_microcontroller_code_generation_h_
#include <emmintrin.h>
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef microcontroller_code_generation_COMMON_INCLUDES_
#define microcontroller_code_generation_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#include "rt_logging.h"
#endif                    /* microcontroller_code_generation_COMMON_INCLUDES_ */

#include "microcontroller_code_generation_types.h"
...
#define microcontroller_code_generation_M (microcontroller_code_generat_M)
...
} DW_microcontroller_code_gener_T;

/* Parameters (default storage) */
struct P_microcontroller_code_genera_T_ {
...
struct tag_RTM_microcontroller_code__T {
...
extern P_microcontroller_code_genera_T microcontroller_code_generati_P;

/* Block states (default storage) */
extern DW_microcontroller_code_gener_T microcontroller_code_generat_DW;

/* Model entry point functions */
extern void microcontroller_code_generation_initialize(void);
extern void microcontroller_code_generation_step(void);
extern void microcontroller_code_generation_terminate(void);

/* Real-time Model object */
extern RT_MODEL_microcontroller_code_T *const microcontroller_code_generat_M;
 ...
 *
 * '<Root>' : 'microcontroller_code_generation'
 * '<S1>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller'
 * '<S2>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Brake Model'
 * '<S3>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Constraint Generation'
 * '<S4>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Normal Force Model'
 * '<S5>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/PIT Controller'
 * '<S6>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Reference Generation'
 * '<S7>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Steering Model'
 * '<S8>'   : 'microcontroller_code_generation/Torque Vectoring Micro Controller/Tire Model'
 */
#endif                       /* RTW_HEADER_microcontroller_code_generation_h_ */
